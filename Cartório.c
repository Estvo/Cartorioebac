...
int registro() //Função responsável por cadastrar os usuario no sistema
{
	...
	char sobrenome[40];
	char cargo[40];
	//Fina da criação de variáveis/string
...

{
	...
	printf("Digite o CPF a ser consultaado:");
	scanf("%s",cpf);
...
int deletar()
{
    ...
    for(laco=1;laco=1;)
	{
	    ...
	    printf("Escolher a opção deseja do menu\n\n");
